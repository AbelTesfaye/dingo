...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public DbHelper(Context context){
        ...
        try {
            // if (Build.VERSION.SDK_INT >= 17) { DB_PATH = context.getApplicationInfo().dataDir + "/databases/"; }
    ...
    private boolean isDbCopied(){
        ...
        Log.e("[DINGO_JAVA]" , "db path set to: " + DB_PATH);
        File dbFile = new File(DB_PATH);
        Log.e("[DINGO_JAVA]" , "db exists: " + dbFile.exists());
    ...
    private void copyDB() throws IOException{
            ...
            Log.e("DINGO_JAVA", "assetFileInputStream"+(assetFileInputStream == null));


        try {
            Log.e("DINGO_JAVA", "Copying pre-populated DB content");
            ...
            Log.e("DINGO_JAVA", "Copied pre-populated DB asset to: " + newDbFile.getAbsolutePath());
        } finally {
            out.close();
        }
