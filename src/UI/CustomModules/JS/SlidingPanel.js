      ...
      onPanResponderRelease: (e, gesture) => {
        ...
        if (a !== 0) {
          ...
          if (this.props.snap) {
            ...
            console.log(
              "this.state.heightAnim: " + this.state.heightAnim._value
            );
            console.log("+maxHeight/2: " + maxHeight / 2);
            if ((this.state.heightAnim._value < (maxHeight / 2)) /*&& ( gesture.v > this.props.snapVelocity)*/) {
              this.onRequestClose();
            } else {
              this.onRequestStart();
            }
